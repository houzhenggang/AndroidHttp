...
public class TextUtil {
	...
	public static String getString(int resId) {
		return SimpleAndroidHttpApplication.getInstance().getApplicationContext().getResources().getString(resId);
	}
	...
	public static String getString(int resId, Object... formatArgs) {
		return SimpleAndroidHttpApplication.getInstance().getApplicationContext().getResources().getString(resId, formatArgs);
	}
	...
	public static String[] getStringArray(int arrayResId) {
		return SimpleAndroidHttpApplication.getInstance().getApplicationContext().getResources().getStringArray(arrayResId);
	}
}
